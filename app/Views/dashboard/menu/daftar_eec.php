...
<div class="content-wrapper" style="min-height: 1643.38px;">
    ...
    <div class="content">
        ...
        <div class="container">
            ...
            <form action="<?= base_url('/menu/daftar/' . $lomba['nama_lomba']); ?>" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="">
                        <h5>Data Team</h5>
                    </div>
                ...
                <div class="form-ketua mt-3">
                    ...
                    <div class="row">
                        <div>
                            <label class="nlabel" for="name">Foto Kartu Pelajar/surat ket. aktif Ketua</label>
                        </div>
                        <div class="col-25">
                ...
                <div class="form-anggota mt-5">
                    ...
                    <div class="row">
                        <div>
                            <label class="nlabel" for="name">Foto Kartu Pelajar/surat ket. aktif Anggota</label>
                        </div>
                        <div class="col-25">
                            <input type="file" id="upload2-eec" class="upload-btn" name="ktm[]" autocomplete="off">
                            <label class="upbtn" for="upload2-eec"  accept=".jpg, .png, .jpeg">Choose File</label>
                        </div>
                        <div class="col-75">
