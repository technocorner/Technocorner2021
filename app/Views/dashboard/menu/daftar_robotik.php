    ...
    <div class="content">
        ...
        <div class="container">
            <div class="title">
                ...
                <h3 class="fcomp">Robotik</h3>
            </div>
            <form action="<?= base_url('/menu/daftarRobotik'); ?>" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div>
                ...
                <div class="form-ketua mt-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-25">
                            <input type="file" id="upload1-eec" class="upload-btn" name="ktm[]" autocomplete="off" accept=".jpg, .png, .jpeg">
                ...
                <div class="form-anggota">
                    <div class="row">
                        <div>
                            <label class="nlabel" for="name">Nama Anggota</label>
                        </div>
                        <div>
                            <input type="text" placeholder="..." name="name[]" autocomplete="off">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-25">
                            <input type="file" class="upload-btn" id="upload2-eec" name="ktm[]" autocomplete="off" accept=".jpg, .png, .jpeg">
                ...
                <div class="row">
                    <div>
                        <label class="nlabel" for="competition">Cabang Lomba</label>
                    </div>

                    <div>
                        <select id="dropmenu" name="lomba">
                            <option value="none" selected disabled>Choose Competition</option>
                            <option value="none" disabled>Line Follower</option>
                            <option value="2">Transporter</option>
                        </select>
                    </div>
                    <?php if (!empty(session()->getFlashdata('errors')['lomba'])) : ?>
                        <div class="validation" style="color: red;">
                            <?= session()->getFlashdata('errors')['lomba'] ?>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="row">
...
<script>
    $(document).ready(function() {
        ...
        $('.btn-add').click(function(e) {
            ...
            const form = ` <div class="form-anggota">
        <div class="row">
            <div>
